"""Wazuh adapter — placeholder interface for .

intentionally does NOT connect to a real Wazuh deployment. The class
exists so the adapter registry, API contract and tests are already shaped for
the real integration, following the "reserve the interface, avoid
